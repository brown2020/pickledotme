          ...
          <div className="mt-8 p-6 bg-slate-50 dark:bg-slate-700/50 rounded-2xl">
            ...
            <ul className="space-y-2 text-slate-600 dark:text-slate-300">
              <li className="flex items-center gap-2">
                <span className="w-6 h-6 bg-emerald-100 dark:bg-emerald-900/50 rounded-full flex items-center justify-center text-emerald-800 dark:text-emerald-300 text-sm font-bold">1</span>
                Watch the sequence of colors flash
              </li>
              <li className="flex items-center gap-2">
                <span className="w-6 h-6 bg-emerald-100 dark:bg-emerald-900/50 rounded-full flex items-center justify-center text-emerald-800 dark:text-emerald-300 text-sm font-bold">2</span>
                Repeat the sequence by clicking the colors
              </li>
              <li className="flex items-center gap-2">
                <span className="w-6 h-6 bg-emerald-100 dark:bg-emerald-900/50 rounded-full flex items-center justify-center text-emerald-800 dark:text-emerald-300 text-sm font-bold">3</span>
                Each round adds one more color
              </li>
              <li className="flex items-center gap-2">
                <span className="w-6 h-6 bg-emerald-100 dark:bg-emerald-900/50 rounded-full flex items-center justify-center text-emerald-800 dark:text-emerald-300 text-sm font-bold">4</span>
