...
| ID | Phase | Priority | Status | Result | Verification |
| --- | --- | --- | --- | --- | --- |
| T-001 | Preflight/docs | P1 | Done | Clean synced `dev`; repo guidance mapped | lint, Git remote/dry-run push |
| T-002 | Baseline | P1 | Done | Outdated/audit/extraneous baseline captured | lint/type/build/outdated/audit |
